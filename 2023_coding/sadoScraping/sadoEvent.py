...
df.to_csv('/Users/taiki/Documents/GitHub/python/Personal_coding/2023_coding/scraping/data/観光地評点.csv', index=False)

# カラムの順番を入れ替える
df = df[['観光地名','評点','楽しさ','人混みの多さ','景色','アクセス']]
df.to_csv('/Users/taiki/Documents/GitHub/python/Personal_coding/2023_coding/scraping/data/観光地評点_カラム整理.csv', index=False)